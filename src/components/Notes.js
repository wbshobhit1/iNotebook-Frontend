        ...
        <div className="modal-content">
          ...
          <div className="modal-body">
              ...
              <div className="mb-3">
                ...
                <input type="text" className="form-control" id="etitle" name="etitle" minLength={3} required value={note.etitle} aria-describedby="emailHelp" onChange={onChange} />
              ...
              <div className="mb-3">
                ...
                <input type="text" className="form-control" id="etag" required name ="etag" onChange={onChange}/>
              </div>
